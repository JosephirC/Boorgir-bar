...
bin/mainTxt: obj/mainTxt.o obj/Jeu.o obj/Recette.o obj/Ingredient.o obj/Commande.o obj/Client.o obj/Menu.o obj/Objectif.o obj/Temps.o obj/winTxt.o obj/txtJeu.o
	g++ obj/mainTxt.o obj/Ingredient.o obj/Recette.o obj/Jeu.o obj/Commande.o obj/Client.o obj/Menu.o obj/Objectif.o obj/Temps.o obj/winTxt.o obj/txtJeu.o -o bin/mainTxt $(SDL_LIB)
...
bin/main: obj/main.o obj/Jeu.o obj/Recette.o obj/Ingredient.o obj/Commande.o obj/Client.o obj/Menu.o obj/Objectif.o obj/Temps.o
	g++ obj/main.o obj/Ingredient.o obj/Recette.o obj/Jeu.o obj/Commande.o obj/Client.o obj/Menu.o obj/Objectif.o obj/Temps.o -o bin/main $(SDL_LIB)
...
obj/Menu.o: src/Menu.cpp src/Menu.h
	g++ -ggdb -Wall -c src/Menu.cpp -o obj/Menu.o $(DIR_SDL)
